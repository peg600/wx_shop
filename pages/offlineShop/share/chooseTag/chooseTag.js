// pages/offlineShop/share/chooseTag/chooseTag.js
...
Page({
  ...
  clearValue: function () {
    ...
    this.triggerEvent("clearSearch", { key: "" }, {});
  },

  search(e) {
    let that = this;
    let key_word = this.data.searchInput;
    let mode = "";
    if(e.currentTarget.dataset.mode) {
      mode = e.currentTarget.dataset.mode;
    }
    wx.navigateTo({
      url: `/pages/offlineShop/share/chooseTag/search/search?x=${that.data.x}&y=${that.data.y}&key_word=${key_word}&mode=${mode}`,
    })
  },
  ...
  chooseTag(e) {
    let tag_data = e.currentTarget.dataset.tag_data;
    let screen_width = this.data.screen_width;

    if (tag_data.shop_id || tag_data.brand_id) {
      let history = {};
      if (tag_data.shop_id) {
      ...
      history.name = tag_data.shop_name ? tag_data.shop_name : tag_data.brand_name;
    ...
    tag.text = tag_data.name ? tag_data.name : tag_data.shop_name;
